            ...
            <main className="pt-32">
                ...
                <section className="relative px-6 md:px-12 py-24 overflow-hidden">
                    <div className="max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        ...
                        >
                            <span className="text-brand-gold uppercase tracking-[0.4em] text-[10px] font-black mb-8 block">Our Legacy</span>
                            <h1 className="text-6xl md:text-8xl font-serif mb-12 leading-[0.9] tracking-tighter">
                            ...
                            <p className="text-brand-ink/70 text-xl font-light leading-relaxed max-w-xl">
                        ...
                        >
                            ...
                            <div className="absolute -bottom-12 -left-12 bg-white p-12 rounded-[2rem] shadow-xl border border-brand-ink/5 max-w-[280px]">
                                <div className="text-brand-gold text-4xl font-serif mb-4">50+</div>
                                <p className="text-[10px] uppercase tracking-widest font-black text-brand-ink/40 leading-relaxed">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
                            <div className="space-y-12">
                                ...
                                <div className="grid grid-cols-2 gap-8">
                                    {[
                                        ...
                                        <div key={i} className="flex flex-col gap-4 p-8 bg-brand-cream rounded-3xl border border-brand-ink/5">
                            ...
                            <div className="space-y-12">
                                <div>
                                    ...
                                    <p className="text-brand-ink/70 text-lg leading-relaxed font-light mb-8">
                                ...
                                <div className="p-12 bg-brand-green rounded-[3rem] text-brand-cream relative overflow-hidden">
                                    <div className="relative z-10">
                                        <h2 className="text-3xl font-serif mb-6">Future-Focused Growth</h2>
                                        <p className="text-brand-cream/70 text-lg leading-relaxed font-light">
                ...
                <section className="py-32 bg-brand-cream">
                    <div className="max-w-[1200px] mx-auto px-6 text-center">
                        <h2 className="text-5xl md:text-7xl font-serif mb-12 tracking-tighter">Join Our Journey</h2>
                        <p className="text-brand-ink/60 text-xl font-light mb-16 max-w-2xl mx-auto">
                            Partner with a leader at the Ontario Food Terminal and grow your success with premium quality produce.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-6 justify-center">
                            <button className="bg-brand-ink text-brand-cream px-12 py-6 rounded-full font-black text-sm uppercase tracking-widest hover:bg-brand-green transition-all shadow-xl">
                                Become a Partner
                            </button>
                            <button className="border border-brand-ink/20 text-brand-ink px-12 py-6 rounded-full font-black text-sm uppercase tracking-widest hover:bg-brand-ink hover:text-brand-cream transition-all">
                                Contact Sales
                            </button>
                        </div>
                    </div>
